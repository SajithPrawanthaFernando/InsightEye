...
export default function HealthTracker({
  ...
  useEffect(() => {
    const welcomeMessage =
      "Welcome to the Emotional Tracker. You can say things like, 'I feel sick', 'I feel unwell'.";
  ...
  const checkEmotionRelated = async (userMessage) => {
      ...
      contents: [
        {
          parts: [
            {
              text: `Is this message related to health or medications? if it is 
        please resopnse "yes" if not response "no" no any other words! Message: "${userMessage}"`,
            },
          ],
        },
      ],
    ...
    try {
      ...
      console.error("Error checking if the message is health-related:", error);
      return false;
    }
  };
      ...
      contents: [
        {
          parts: [
            {
              text: `When the visually impaired child asks for medical advice, 
        provide a brief and clear response with specific over-the-counter medications.
         Advise the child to take these medications with an adult’s 
        recommendation and mention possible outcomes if the medications are not used.
         Always suggest consulting a healthcare professional for specific or ongoing issues. 
         Keep responses clear and concise.! Message: "${userMessage}"`,
            },
          ],
        },
      ],
  ...
  const handleSend = async (userMessage) => {
    ...
    if (isEmotionRelated) {
      ...
      setMessages((prevMessages) => [
        ...
        {
          role: "assistant",
          content: "Please provide Health-related things.",
        },
      ]);
      speak("Please provide Health-related things.");
    }
  };
